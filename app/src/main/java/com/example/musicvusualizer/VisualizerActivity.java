...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setUpSharedPrefrences() {
        ...
        //setting from preference
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.pref_show_basskey), true));
        mVisualizerView.setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_show_midkey), true));
        mVisualizerView.setShowTreble(sharedPreferences.getBoolean(getString(R.string.pref_show_trebelkey), true));
        loadSizeFromPrefrences(sharedPreferences);
        loadColorFromPrefrences(sharedPreferences);
    ...
    private void loadSizeFromPrefrences(SharedPreferences sharedPreferences) {
        float minSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_size_key), getString(R.string.default_pref)));
        mVisualizerView.setMinSizeScale(minSize);
    }

    //color setting from shared preference
    private void loadColorFromPrefrences(SharedPreferences sharedPreferences) {
